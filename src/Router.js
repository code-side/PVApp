...
<Router
  ...
  sceneStyle={{ paddingTop: 54 }}>
     ...
     <Scene key="home" component={Home} title="PVApp"/>
      ...
      <Scene key="touristDestinationList" component={TouristDestinationList} title ="Destinos Turisticos"/>
      <Scene key="touristDest" component = {TouristDestination} title= "Destino Turistico"/>
    </Router>
  );
};
